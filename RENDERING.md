...
The Solar system shown in System mode is generated by `system.rs` from a
seed using observed-astrophysics statistics (IMF, Kepler period ratios,
Kopparapu HZ, Chen & Kipping mass-radius). See *Solar systems* below.
